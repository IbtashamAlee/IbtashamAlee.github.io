      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            ...
            crafting exceptional software solutions, I bring a strong skill set
            to every project. Beyond my love for technology, I am also an avid
            gym-goer, committed to maintaining a strong and healthy physique.
          </p>
          <div className="mt-6 flex gap-6">
            ...
            />
            <SocialLink
              href="https://linkedin.com/in/ibtashamalee"
